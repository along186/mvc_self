...
* ==============================================
* @date: 2016年5月5日  上午10:34:18
* @author: liufeilong(alonglovehome@163.com)
* @version: 1.0.0.0
*/
class TemplateMyStreamDriver extends BaseView{
    ...
    public function getTemplateHandle($config_key){
        ...
        BaseService::includeClassFile(BASE_PATH.DS.'Base'.DS.'Templates/mystream/MyStreamView.class.php');
        $mystreamView = new MyStreamView($template,$template_config['cache_redis_host'],$template_config['cache_redis_port'],$template_config['cache_data_expire']);
        $mystreamView->debug = true;
        return $mystreamView;
    }
    /**
     * assign
